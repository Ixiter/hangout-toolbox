...
LowerThird.prototype.buildDOM = function(){		
	...
	*/ 
    ...
    var inputCheckbox = this.createElement("input", {
        "class": "input", 
        "type": "checkbox", 
        "disabled": "disabled"
    });
    var cleardiv = this.createElement("div", {
        "class": "clear"
    });
	...
	*/
	 ...
	 * Creates the form element
	*/
    var fieldset_lowerthird	= this.createElement("fieldset", {
        "class": "fieldset"
    });
    var fieldset_clock		= this.createElement("fieldset", {
        "class": "fieldset", 
        "id": "hotb-clock"
    });
    var fieldset_custom		= this.createElement("fieldset", {
        "class": "fieldset"
    });
    var fieldset_mirrored	= this.createElement("fieldset", {
        "class": "fieldset"
    });
    var fieldset_presets	= this.createElement("fieldset", {
        "class": "fieldset"
    });

    var legend_lowerthird	= this.createElement("legend", {
        "class": "legend"
    }).text("Lower Third").appendTo(fieldset_lowerthird);
    var legend_clock		= this.createElement("legend", {
        "class": "legend"
    }).text("Display clock").appendTo(fieldset_clock);
    var legend_custom	 	= this.createElement("legend", {
        "class": "legend"
    }).text("Custom Overlay").appendTo(fieldset_custom);
    var legend_mirrored		= this.createElement("legend", {
        "class": "legend"
    }).text("Mirror").appendTo(fieldset_mirrored);
    var legend_preset 		= this.createElement("legend", {
        "class": "legend"
    }).text("Presets").appendTo(fieldset_presets);

    var switch_lowerthird	= this.createElement("a",{
        "id": "switch_lowerthird", 
        "class": "onoffswitch"
    });
    var switch_clock		= this.createElement("a",{
        "id": "switch_clock", 
        "class": "onoffswitch"
    });
    var switch_custom		= this.createElement("a",{
        "id": "switch_custom", 
        "class": "onoffswitch"
    });

    var button_save			= this.createElement("a", {
        "id": "lowerthird-save-button", 
        "class": "general-button-blue", 
        "title":"Save preset"
    }).html("Save");
    var button_mirror		= this.createElement("a", {
        "id": "lowerthird-mirror-button", 
        "class": "general-button-blue", 
        "title":"Mirror own video"
    }).css({
        "margin-left":"43px"
    }).html("Mirror my own video");

    var radio_left			= this.createElement("input", {
        "type": "radio", 
        "id":"radio-button-left", 
        "name":"clock", 
        "checked":"checked"
    });
    var radio_left_text		= label.clone().attr({
        "for": "name"
    }).text("Left");
    var radio_right			= this.createElement("input", {
        "type": "radio", 
        "name":"clock", 
        "id":"radio-button-right"
    });
    var radio_right_text	= label.clone().attr({
        "for": "name"
    }).text("Right");
    var radio_hours24		= this.createElement("input", {
        "type": "radio", 
        "id":"radio-hours-24", 
        "name":"clock_hours", 
        "checked":"checked"
    });
    var radio_hours24_text		= label.clone().attr({
        "for": "name"
    }).text("24 hours");
    var radio_hours12		= this.createElement("input", {
        "type": "radio", 
        "id":"radio-hours-12", 
        "name":"clock_hours"
    });
    var radio_hours12_text		= label.clone().attr({
        "for": "name"
    }).text("12 hours");

    var nopresets			= span.clone().text("No saved presets!");

    var inputText_name 		= inputText.clone().attr({
        "id": "Name", 
        "class": "box_text", 
        "name": "name"
    });
    var inputText_tagline 	= inputText.clone().attr({
        "id": "Tag", 
        "class": "box_text", 
        "name": "tagline", 
        "value":""
    ...
    var inputColor  		= inputText.clone().attr({
        "id": "Color", 
        "class": "box_text color", 
        "name": "color", 
        "value": "dd4b39"
    });
    var inputText_preset	= inputText.clone().attr({
        "id": "PreName", 
        "class": "box_text2", 
        "name": "preset"
    });
    var inputSelectFlag		= this.createElement("select", {
        "id": "SelectFlag", 
        "class": "box flag"
    });
    ...
    for(var i = 0; i < countries.length; i++){
        ...
        option.clone().attr({
            "value": value
        }).text(name).appendTo(inputSelectFlag);
    }

    var inputFile_logo 		= this.createElement("input", {
        "type": "file", 
        "id": "iconfile", 
        "class": "box", 
        "name": "logo"
    });
    var inputFile_custom	= this.createElement("input", {
        "type": "file", 
        "id": "customfile", 
        "class": "box", 
        "name": "custom"
    ...
    var spacer 				= div.clone().css({
        "margin-left":"25px", 
        "margin-top":"10px"
    });

    var donate 				= this.createElement("a", {
        "href": "https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=3YRQBKYGF38ZL", 
        "class":"button",
        "target":"_blank", 
        "title":"Any donation is much appreciated. \n\n With a donation you support the development of this and other Hangout apps. Thank you!"
    }).html("Fund Development");

    var hr_line				= this.createElement("hr", {
        "class":"line"
    });

    var presetlist			= this.createElement("ul", {
        "id":"lowerthird-preset-list"
    });
    ...
    var dialog 				= this.createElement("div", {
        ...
        "class":"dialog"
    }).html("<p>You are running the Hangout Toolbox for the first time. Please be aware that all overlays of Lower Third will appear mirrored for you! <br />Everyone else in the Hangout will see the overlays correctly!</p>");
    var error1 				= this.createElement("div", {
        "id":"dialog-error1",
        "title":"No name entered",
        "class":"error"
    }).html("<p>Please enter a name for your preset first!</p>");
	...
	*/
    this.canvas = this.createElement("canvas", {
        "id":"canvas"
    }).height("75").width("640")[0];
    this.canvas_custom = this.createElement("canvas", {
        "id":"canvas_custom"
    }).height("360").width("640")[0];
    this.canvas_clock = this.createElement("canvas", {
        "id":"canvas_clock"
    }).height("360").width("640")[0];
...
LowerThird.prototype.createClock = function(currentTime){
    ...
    if(jQuery("input[name=clock_hours]:checked").attr('id') == 'radio_hours12'){
...
LowerThird.prototype.generatePresets = function(){
    ...
    if(presets_out.length === 0){
        ...
        for(i = 0; i < presets_out.length; i++){
            ...
            var deleteButton = this.createElement("a",{
                "class":"lowerthird-delete-preset", 
                "title":"Delete this preset.  WARNING: this cannot be undone!"
            });
            var loadButton = this.createElement("a",{
                "class":"lowerthird-load-preset", 
